...
new.cluster.ids <- c("Mesenchymal","T_helper","B","Mesenchymal","Mesenchymal",
                      "Endothelial","CD8_T","Mesenchymal","Th17","Macrophage","Epithelial","Dendritic","Mesenchymal",
...
new.cluster.ids <- c("Mesenchymal", "T_helper", "B", "Mesenchymal", "Mesenchymal", "Endothelial", "CD8_T", "Mesenchymal", "Th17", "Macrophage", "Epithelial", "Dendritic", "Mesenchymal", "NKT", "Endothelial", "Basal", "Monocyte", "Treg", "Treg")
